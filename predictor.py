...
def main(input_fasta_name, output_csv_name, model_type= None):
    ...
    if model_type == 'n18':
        model = load_model('/home/AI4AVP_predictor_improved/model/model18_nn_PC_6_model_n_best_weights.h5')
    if model_type == 'aug18':
        model = load_model('/home/AI4AVP_predictor_improved/model/model18GAN_PC_6_model_best_weights.h5')
    if model_type == 'influ':
        model = load_model('/home/AI4AVP_predictor_improved/model/Influ_PC_6_model_n_best_weights.h5')
